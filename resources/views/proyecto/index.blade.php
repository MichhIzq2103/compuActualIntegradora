                                ...
                                <tbody>
                                    @foreach ($proyectos as $proyecto)
                                        <tr>
											...
											<td>{{ $proyecto->CostoFinal }}</td>
											<td>{{ $proyecto->CostoAprox }}</td>
											<td>{{ $proyecto->FechaRecibido }}</td>
											<td>{{ $proyecto->FechaEntregado }}</td>
											<td>{{ $proyecto->DineroAcuenta }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('proyectos.destroy',$proyecto->id) }}" method="POST">
                                                    ...
                                                    <a class="btn btn-sm btn-success" href="{{ route('seguimientos.edit',$proyecto->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Seguimiento') }}</a>
